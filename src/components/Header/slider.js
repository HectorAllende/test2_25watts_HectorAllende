                        ...
                        <div className="carousel-inner">
                            ...
                            <div className="carousel-item" data-bs-interval="3000">
                                ...
                                <div className="carousel-caption  container">
                                    ...
                                    <div className="carousel-indicators">
                                        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" className="indicador" aria-current="true" aria-label="Slide 1"></button>
                                        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" className='indicador active' aria-label="Slide 2"></button>
                                        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" className='indicador' aria-label="Slide 3"></button>
                                    </div>
                            ...
                            <div className="carousel-item" data-bs-interval="3000">
                                ...
                                <div className="carousel-caption container">
                                    ...
                                    <div className="carousel-indicators">
                                        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" className="indicador" aria-current="true" aria-label="Slide 1"></button>
                                        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" className='indicador' aria-label="Slide 2"></button>
                                        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" className='indicador active' aria-label="Slide 3"></button>
                                    </div>
